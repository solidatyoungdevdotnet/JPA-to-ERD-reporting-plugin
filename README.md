...
- headerColor - Color (in hex) used to shade the entity table name background.  The new default is ![#98BFDA] #98BFDA (MySQLWorkbench) the old default used to be ![#B19CD9] #B19CD9 (ERMaster)
